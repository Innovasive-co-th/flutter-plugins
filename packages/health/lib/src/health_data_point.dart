...
class HealthDataPoint {
  ...
  /// The model of the source from which the data point was fetched.
  ...
  @override
  int get hashCode => Object.hash(value, unit, dateFrom, dateTo, type, platform, deviceId, sourceId, sourceName, model);
}
